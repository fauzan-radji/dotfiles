...
export interface ReconcileContext extends UpdateReason {
     ...
     */
    reloadModule<TModule>(prepareModule?: (mod: NodeModule) => void): {
        newExports: TModule;
 ...
 */
export declare type Reconciler = (context: ReconcileContext) => boolean;
/**
 * @unstable
 * Sets a reconciler for the given module.
 */
export declare function setModuleReconciler(module: NodeModule, reconciler: Reconciler | undefined): void;
export declare function getModuleReconciler(module: NodeModule): Reconciler | undefined;
export declare const nodeModuleSourceProperty: AttachedProperty<NodeModule, string | undefined>;
