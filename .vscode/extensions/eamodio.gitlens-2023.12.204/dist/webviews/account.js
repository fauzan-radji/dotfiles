...
`;var Ct=Object.defineProperty,Pt=Object.getOwnPropertyDescriptor,Et=(e,t,o,r)=>{for(var i,s=r>1?void 0:r?Pt(t,o):t,c=e.length-1;c>=0;c--)(i=e[c])&&(s=(r?i(t,o,s):i(s))||s);return r&&s&&Ct(t,o,s),s};let Rt=class extends lit_element_s{constructor(){super(...arguments),this.full=!1,this.disabled=!1,this.tabIndex=0}get role(){return this.href?"link":"button"}updated(e){super.updated(e),e.has("disabled")&&(this.tabIndex=this.disabled?-1:0,this.setAttribute("aria-disabled",this.disabled.toString()))}render(){const e=ht`<slot></slot>`;return null!=this.href?ht`<a href=${this.href}>${e}</a>`:e}};Rt.styles=[xt,Se`
			:host {
		...
		`],Dt([$t({type:Boolean})],Lt.prototype,"editor",2),Lt=Dt([yt("button-container")],Lt);var Bt=Object.defineProperty,Ut=Object.getOwnPropertyDescriptor,Ot=(e,t,o,r)=>{for(var i,s=r>1?void 0:r?Ut(t,o):t,c=e.length-1;c>=0;c--)(i=e[c])&&(s=(r?i(t,o,s):i(s))||s);return r&&s&&Bt(t,o,s),s};let It=class extends lit_element_s{constructor(){super(...arguments),this.icon="",this.modifier="",this.size=16}updated(e){e.has("size")&&this.style.setProperty("--code-icon-size",`${this.size}px`),super.update(e)}};It.styles=Se`
		:host {
	...
	`,Ot([$t()],It.prototype,"icon",2),Ot([$t()],It.prototype,"modifier",2),Ot([$t({type:Number})],It.prototype,"size",2),It=Ot([yt("code-icon")],It);var Ht=Object.defineProperty,zt=Object.getOwnPropertyDescriptor,Nt=(e,t,o,r)=>{for(var i,s=r>1?void 0:r?zt(t,o):t,c=e.length-1;c>=0;c--)(i=e[c])&&(s=(r?i(t,o,s):i(s))||s);return r&&s&&Ht(t,o,s),s};let Ft=class extends lit_element_s{constructor(){super(...arguments),this.image="",this.name="",this.days=0,this.state=o.Free,this.plan="",this.trialReactivationCount=0}get daysRemaining(){return this.days<1?"<1 day":F("day",this.days)}get planName(){switch(this.state){case o.Free:case o.FreePreviewTrialExpired:case o.FreePlusTrialExpired:return"GitKraken Free";case o.FreeInPreviewTrial:case o.FreePlusInTrial:return"GitKraken Pro (Trial)";case o.VerificationRequired:return`${this.plan} (Unverified)`;default:return this.plan}}get daysLeft(){switch(this.state){case o.FreeInPreviewTrial:case o.FreePlusInTrial:return`, ${this.daysRemaining} left`;default:return""}}get hasAccount(){return null!=(e=this.state)&&0!==e&&2!==e&&1!==e;var e}get isReactivatedTrial(){return this.state===o.FreePlusInTrial&&this.trialReactivationCount>0}renderAccountInfo(){return this.hasAccount?ht`
		...
		`:bt}renderAccountState(){const e=Date.now()<new Date("2023-12-06T07:59:00.000Z").getTime();switch(this.state){case o.VerificationRequired:return ht`
				...
				`;case o.Free:case o.FreeInPreviewTrial:case o.FreePreviewTrialExpired:return ht`
					<p>
				...
				`;case o.FreePlusTrialExpired:return ht`
					...
					${At(e,(()=>ht`<p style="text-align: center;">
								...
								>
							</p>`),(()=>ht`<p style="text-align: center;">
				...
				`;case o.FreePlusInTrial:return ht`
					<p>
						${this.isReactivatedTrial?ht`<a href="https://help.gitkraken.com/gitlens/gitlens-release-notes-current/"
										>See what's new</a
									>
									with
				...
				`}return bt}render(){return ht`${this.renderAccountInfo()}${this.renderAccountState()}`}};Ft.styles=[xt,St,Se`
			:host {
				display: block;
		...
		`],Nt([$t()],Ft.prototype,"image",2),Nt([$t()],Ft.prototype,"name",2),Nt([$t({type:Number})],Ft.prototype,"days",2),Nt([$t({type:Number})],Ft.prototype,"state",2),Nt([$t()],Ft.prototype,"plan",2),Nt([$t({type:Number})],Ft.prototype,"trialReactivationCount",2),Ft=Nt([yt("account-content")],Ft);class AccountApp extends App{constructor(){super("AccountApp")}onInitialize(){this.state=this.getState()??this.state,this.updateState()}onBind(){const e=super.onBind?.()??[];return e.push(q.on("[data-action]","click",((e,t)=>this.onDataActionClicked(e,t)))),e}onMessageReceived(e){if(e.method===l.method)s(l,e,(e=>{this.state.subscription=e.subscription,this.state.avatar=e.avatar,this.state.timestamp=Date.now(),this.setState(this.state),this.updateState()}));else super.onMessageReceived?.(e)}onDataActionClicked(e,t){const o=t.dataset.action;this.onActionClickedCore(o)}onActionClickedCore(e){e?.startsWith("command:")&&this.sendCommand(h,{command:e.slice(8)})}getDaysRemaining(){return this.state.subscription.state!==o.FreePlusInTrial?0:r(this.state.subscription,"days")??0}updateState(){const e=this.getDaysRemaining(),{subscription:t,avatar:o}=this.state,r=document.getElementById("account-content");r.image=o??"",r.name=t.account?.name??"",r.state=t.state,r.plan=t.plan.effective.name,r.days=e,r.trialReactivationCount=t.plan.effective.trialReactivationCount}}new AccountApp;var Gt=t.d;export{Gt as AccountApp};